...
//Escribir "No aplica a ningún descuento. "
//Escribir "El precio final a pagar es: ", preciofinal
Funcion ejercicio3
...
//SALIDA
//Escribir "Después de aplicar el descuento se va a aplicar el 15% de IVA: "
...
Funcion ejercicio6
	...
	edad=0
	Escribir"Ingrese un valor y segun eso se determinara que rango de edad tiene"
	Leer edad
...
//De Otro Modo:
//Escribir "Puntuación fuera del rango válido (1-10)"
Funcion ejercicio8
...
//leer cuenta
//Escribir "¿Cómo califica el servicio? (B)ueno (10%) o (E)xcelente (15%):'
//Leer servivio
...
//ENTRADA
//Definir año(leer)=0 como entero
//PROCESO
...
Funcion ejercicio22
	...
	Escribir "Menor a 90 - Presión baja "
	Escribir "Entre 90 y 120 - Presión normal "
	Escribir "Entre 121 y 139 - Prehipertensión"
	Escribir "140 o más - Hipertensión "
	si presion < 90 Entonces
		Escribir "Presion baja"
	SiNo
